...
def mainGame():
    ...
    playerMaxVelY = 10 #Max velocity of Player along Y-axis i.e max descending speed
    playerMinVelY = -8 #Min velocity of Player along Y-axis i.e max ascending speed
...
if __name__ == "__main__":
    ...
    while True:
        welcome() # Shows welcome screen to the user until he presses a button
